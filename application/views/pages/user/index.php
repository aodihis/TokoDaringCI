                    ...
                    <div class="float-right">
                        <form action="<?=base_url('user/search')?>" method='POST'>
                            <div class="input-group">
                                <input class="form-control form-control-sm text-center" name="keyword" type="text" placeholder="Cari" value=<?=$this->session->userdata('keyword')?>>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        <img 
                                        src="<?= $row->image ? base_url("images/user/$row->image") : base_url("images/user/avatar.png") ?>" alt="" height = "50">
                                        <?= $row->name ?>
                                    </p>
                                </td>
                                <td><?=$row->email?></td>
