                    ...
                    <?=form_open_multipart($form_action, ['method'=>'POST'])?>
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input(['type' => 'number', 'value' => $input->price, 'name' => 'price',
                                'class' => 'form-control', 'id' => 'price', "required" => true ] )?> 
                            <?=form_error('price')?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="">Ketersedian Stok : </label>
                            <br>
                            <div class="form-check form-check-inline">
                                <?= form_radio(['name' => 'is_available', 'value' => 1, 'checked' => 
                                $input->is_available == 1 ? true : false, 'class' => 'form-check-input'])?>
                                <label for="" class="form-check-label">Tersedia</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <?= form_radio(['name' => 'is_available', 'value' => 0, 'checked' => 
                                $input->is_available == 0 ? true : false, 'class' => 'form-check-input'])?>
