                    ...
                    <div class="float-right">
                        <form action="<?=base_url('product/search')?>" method = "POST">
                            <div class="input-group">
                                <input name="keyword" class="form-control form-control-sm text-center" type="text" placeholder="Cari" value="<?=$this->session->userdata('keyword')?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        <img 
                                        src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.png") ?>" alt="" height = "50">
                                        <?= $row->product_title ?>
                                    </p>
                                </td>
                                <td>
