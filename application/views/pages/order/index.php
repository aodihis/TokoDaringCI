                    ...
                    <div class="float-right">
                        <?= form_open(base_url('order/search'),['method'=>'POST']) ?>
                            <div class="input-group">
                                <input class="form-control form-control-sm text-center" name="keyword" type="text" placeholder="Cari" 
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= str_replace('-', '/',date("d-m-Y", strtotime($row->date)))?>
                                </td>
                                <td>
                                    Rp.<?=number_format($row->total,0,',','.')?>,00
                                </td>
                                <td>
