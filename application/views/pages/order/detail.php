                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><strong>Rp.<?=number_format(array_sum(array_column($order_detail, 'subtotal')),0,',','.')?>,00</strong></td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="card-footer">
                            <form action="<?=base_url("order/update/$order->id")?>" method="POST">
                                <div class="input-group">
                                    <select name='status' id="my-select" class="form-control" name="">
                    ...
                    <div class="col md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>Nominal: Rp.<?=number_format($order_confirm->nominal,0,',','.')?>,00</p>
